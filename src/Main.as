package
{
	...
	public class Main extends Sprite
	{
		...
		{			
			var index:int = MovieClip(ml.loader.content).index as int;
			trace( "data/" + links[index].id + " : is  i wantz to loadz");
		...
		private function buildCourseMap():void 
		{
			...
			list.x = 20;
			list.y = 60;
			list.defaultTextFormat = FontManager.QuestionTextFormatWhite;
			...
			for (var i:int = 0; i < links.length; i++)
			{
				...
				if (links[i].id == currentLesson.id)
				{
					//trace("HIGHLIGHT: " + links[i].title);

					list.htmlText += "<u>" + links[i].title +  "</u>";
				}
				else
				{
					list.htmlText += "" + links[i].title +  "";
				}
			}
			//list.htmlText += "</ul>";
		...
		private function buildResources():void 
		{
			...
			{
				list.htmlText += "<p><a href=\"event:" + resources[i].href+ "\">" +resources[i].title+ "</a><br></p>";
			}
			 addEventListener(TextEvent.LINK, linkHandler);
			 ep.addChild(list);
		}
		  private function openResource(file:String):void 
		  {
		...
		public function handleHelpClick(e:MouseEvent):void
		{
			...
			hs.helpText.embedFonts = true;
			hs.helpText.htmlText = "ICE Media Player v. 1.0\n";
			hs.helpText.htmlText+=("May 2012<br><br>");
			hs.helpText.htmlText+= 'To report a technical problem, please contact Technical Support: <a href="mailto:keith.bridges@windwalker.com?cc=paul.makarov@windwalker.com&subject=Amtrak%20Feedback%20from%20ICE%20Player%20v1.0&body=Your%20comments%20go%20here..."><u>techsupport@windwalker.com<u></a>';
			hs.helpText.htmlText+=("<br/>We appreciate your feedback!<br/><br/>");
			hs.helpText.htmlText+=("<p><a href=\"event:" + helpDoc[0].href+ "\"><u>" + helpDoc[0].title+ "</u></a><br></p>");
